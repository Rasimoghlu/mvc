    ...
    <div class="container">
        ...
        <form action="/users/store" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" name="name" value="<?= e(old('name')) ?>">
            ...
            <div class="form-group">
                ...
                <?php if ($emailError = error('email')): ?>
                    <div class="error"><?= e($emailError) ?></div>
                <?php endif; ?>
            </div>
            ...
            <div class="form-group">
                ...
                <?php if ($passwordError = error('password')): ?>
